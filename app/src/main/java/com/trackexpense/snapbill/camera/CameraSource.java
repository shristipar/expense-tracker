...
public class CameraSource {
     ...
     * ratio.  On some hardware, if you would only set the preview size, you will getAllOrderBy a distorted
     * image.
     *
    ...
    private class FrameProcessingRunnable implements Runnable {
        ...
        public void run() {
            ...
            while (true) {
                ...
                // the camera to call pending frame(s) while we are running detection on the current
                // frame.
